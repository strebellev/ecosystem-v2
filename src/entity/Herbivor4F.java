...
public class Herbivor4F {
	PApplet parent;
	ArrayList<PVector> herb4f;
	...
	public Herbivor4F(PVector l, DNA2 dna2_, PApplet p){
		herb4f = new ArrayList<PVector>();
	...
	public void display(PApplet p){
		...
		//p.text("water " + water, position.x +10, position.y+40);
	...
	public ArrayList<PVector> getHerbivor4F(){
		return herb4f;
	}
