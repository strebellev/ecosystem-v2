...
public class Carnivor2M {
	PApplet parent;
	ArrayList<PVector> carn2m;
	...
	public Carnivor2M(PVector l, DNA3 dna3_, PApplet p){
		carn2m = new ArrayList<PVector>();
	...
	public void display(PApplet p){
		...
		//p.text("water " + water, position.x +10, position.y+20);
	...
	public ArrayList<PVector> getCarnivor2M(){
		return carn2m;
	}
